  ...
  return (
    <View style={styles.container}>
      ...
      <Image style= {styles.titik}
           source={require('../assets/titik2.png')} 
         />
      <Button width={246} height={50} placeholder="Next" backgroundColor="#786AD0" textColor="white" marginTop={35} onPress={() => navigation.navigate('welcome')} />
