  ...
  const renderItem = ({ item }) => (
    <View style={{ marginLeft: 13, marginTop: 10 }}>
      ...
      <View style={{ position: 'relative' }}>
          ...
          <View style={{ position: 'absolute', top: 16, left: 15, width: 57, height: 24,  borderRadius: 6, backgroundColor: '#FFFFFF', justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ fontSize: 10, color: "black", }}>Musik</Text>
          </View>
